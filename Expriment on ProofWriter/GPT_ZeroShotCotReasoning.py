...
if __name__ == "__main__":
    ...
    file_path_ABR = Model + "_Logs_ZeroShotCot_" + Set + ".txt"
    
    file_path = Model + "_Correct_ZeroShotCot_" + Set + ".txt"
